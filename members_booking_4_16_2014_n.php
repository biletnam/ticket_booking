...
<section class="c_form">
        ...
        <form id="req_mem_ticket_form" method="post" action="#">
            ...
            <b style="font-family:'Calibri';"> We are members of 2014 and want to book 
             <select required id="selectmax" name="no_ticket" style="border: 2px solid #0E4B99;width:137px;padding:2px;8px;">
...
font-family: Calibri;"></textarea><br/> <b style="font-family:'Calibri';">We agree to pay total
